...
class ImageRegionIterator< RLEImage< TPixel, VImageDimension, CounterType > > : public ImageRegionConstIterator< RLEImage< TPixel, VImageDimension, CounterType > >
{
public:
...
protected:
  ...
  ImageRegionIterator( const ImageRegionConstIterator< ImageType >& it ) { this->ImageConstIterator< ImageType >::operator=( it ); }
  Self&
...
template < typename TPixel, unsigned int VImageDimension, typename CounterType >
class ImageRegionIteratorWithIndex< RLEImage< TPixel, VImageDimension, CounterType > > : public ImageRegionConstIteratorWithIndex< RLEImage< TPixel, VImageDimension, CounterType > >
{
public:
  ...
  * ImageIterator to a ImageRegionConstIterator. */
  ImageRegionIteratorWithIndex( const ImageIterator< ImageType >& it ) { this->ImageRegionConstIteratorWithIndex< ImageType >::operator=( it ); }
  ...
  * ImageIterator to a ImageRegionIteratorWithIndex. */
  ImageRegionIteratorWithIndex( const ImageConstIterator< ImageType >& it ) { this->ImageRegionConstIterator< ImageType >::operator=( it ); }
